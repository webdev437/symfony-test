...
class Customer
{
    ...
    */
     ...
     * @ORM\Column(type="string", length=255, nullable=true)
     */
    private $isAllowedRunReport;

    /**
     * @ORM\Column(type="string", length=255, nullable=true)
     */
    private $canGenerateReports;
     ...
     * @return string|null
     */
    public function getIsAllowedRunReport(): ?string
    {
        return $this->isAllowedRunReport;
    }

    /**
     * @param string|null $isAllowedRunReport
     * @return Customer
     */
    public function setIsAllowedRunReport(?string $isAllowedRunReport): self
    {
        $this->isAllowedRunReport = $isAllowedRunReport;
     ...
     * @return string|null
     */
    public function getCanGenerateReports(): ?string
    {
        return $this->canGenerateReports;
    }

    /**
     * @param string|null $canGenerateReports
     * @return Customer
     */
    public function setCanGenerateReports(?string $canGenerateReports): self
    {
